...
import belyakovsky.searchengine.config.Site;
import belyakovsky.searchengine.config.SitesList;
import belyakovsky.searchengine.model.*;
...
import belyakovsky.searchengine.util.JsoupUtil;
...
public class IndexingServiceImpl implements IndexingService {
    ...
    public float calculateLemmaRank(String lemma,
    ...
    public void savePageContentAndSiteStatusTime(PageEntity pageEntity,
                                                 String pageHtml,
    ...
    public void saveSinglePageContentAndSiteStatusTime(PageEntity pageEntity,
                                                       String pageHtml,
                                                       SiteEntity siteEntity) {
        savePageAndSite(pageEntity, pageHtml, siteEntity);
    }
    ...
    private void indexAll() {
        ...
        for (Site site : sites.getSites()) {
            log.info("start indexing " + site.getName() + " , url = " + site.getUrl());
    ...
    private void indexSingleSite(Site site) {
        try {
            ...
            log.warn("FAILED to complete indexing '{}'",site.getName());
    ...
    private void handleLemmasAndIndexOnSinglePage(String html,
    ...
    private boolean isCertificateError(Exception e) {
        return e instanceof CertificateExpiredException
