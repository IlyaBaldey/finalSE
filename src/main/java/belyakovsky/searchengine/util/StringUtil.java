package belyakovsky.searchengine.util;

import belyakovsky.searchengine.exceptions.SiteException;
...
public class StringUtil {
    ...
    private boolean isLastEntry(Map.Entry<Integer, Integer> entry,
